...
module.exports = {
	seed: async (knex) => {
		...
		await knex('menu').insert([
            ...
            {itemId: 'c40c2705-4547-4129-8e10-1d0493c557d4', naam: 'Sweet Chilli Mayo', prijs: 0.5, type: 'Sauces', beschrijving: ''},
            {itemId: 'd45979ca-fd2b-428f-b5c7-56ed3cd41fb7', naam: 'Cocktail', prijs: 0.5, type: 'Sauces', beschrijving: ''},
            {itemId: 'e2b6d0c8-6df2-4678-9beb-3e26b21adf70', naam: 'Wasabi Mayo', prijs: 0.5, type: 'Sauces', beschrijving: ''},
            {itemId: 'e8678d0e-b741-4300-a4e4-977b90d621ed', naam: 'Curry', prijs: 0.5, type: 'Sauces', beschrijving: ''},
